...
const Signup: React.FC = () => {
    ...
    <div className='flex flex-col gap-13 m-4'>
        ...
        <div className='flex flex-col gap-4'>
            <div className='flex flex-col justify-center h-18 border-1 border-green-500 rounded p-2 gap-1' tabIndex={0} onFocus={() => setShowName(true)} onBlur={() => setShowName(false)}>
                <label htmlFor="name" className={`text-green-500 font-sans ${showName ? "flex" : "hidden"}`}>Name</label>
                <input type="name" name='name' id='name' placeholder='Enter your name' className='outline-none' ref={nameRef}/>
            </div>
        ...
        <button className='bg-green-500 text-white p-5 rounded-md text-xl cursor-pointer hover:bg-green-600' onClick={handleSignup}>Sign Up</button>
        ...
        <span className='text-sm text-gray-400 text-center'>Already have account? Let&#39;s <Link href="login" className='text-green-500 underline hover:text-green-600'>Sign in</Link></span>
    </div>
    )
}
